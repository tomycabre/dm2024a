...
for (vmax_depth in c(6, 8, 4)) {
  for (vmin_split in c(500, 525, 550, 575, 600, 625, 650, 675, 700)) {
    for (vmin_bucket in unique(as.integer(c(vmin_split/2, vmin_split/3, vmin_split/4)))) {
